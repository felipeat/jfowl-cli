...
public class Fowl {
	...
	public static Dictionary<String, String> obterConhecimento(String url) throws FowlException {
		...
		System.out.println("Entidades identificadas: " + entidades.size());
		}
		catch (Exception e) {
		...
		for (Entidade e : entidades) {
			System.out.println(e + "\t" + e.getHits() + "\t" + e.getGrau() + "\t" + e.getScore1());
//			System.out.println("Relacionados: " + e.getRelacionados());
		}
